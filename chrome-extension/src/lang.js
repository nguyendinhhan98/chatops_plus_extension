...
const en = {
  ...
  giphyGuideStep2: 'Click <strong>Create an App</strong> → choose <strong>API (not SDK)</strong>',
...
const vi = {
  ...
  giphyGuideStep2: 'Nhấn <strong>Create an App</strong> → chọn <strong>API (not SDK)</strong>',

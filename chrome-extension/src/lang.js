...
const en = {
  ...
  toolsFilesSubTab: 'Files',
  noChannelFiles: 'No files found in this channel.',
  noChannelImages: 'No images found in this channel.',
  channelFilesLoading: 'Loading files and images...',
  selectChannelLabel: 'Select chat channel:',
  filterImages: 'Images',
  filterDocuments: 'Documents',
  searchFilePlaceholder: 'Search files/images...',
  ...
  noChannelFiles: 'No files found in this channel.',
  channelFilesLoading: 'Loading channel files...',
  channelFilesImagesOnly: 'Showing images only',
  selectChannelLabel: 'Select chat channel:',
  filterImages: 'Images',
  filterDocuments: 'Documents',
  searchFilePlaceholder: 'Search file/image name...',
  ...
  tourStepFilesTitle: '📎 Files sub-tab',
  tourStepFilesDesc: 'View and manage all files and images shared in the current channel. Supports pagination, name search, and direct inserting into chat!',
...
const vi = {
  ...
  toolsFilesSubTab: 'Tệp tin',
  noChannelFiles: 'Không tìm thấy tệp nào trong kênh này.',
  noChannelImages: 'Không tìm thấy ảnh nào trong kênh này.',
  channelFilesLoading: 'Đang tải tệp và ảnh...',
  selectChannelLabel: 'Chọn kênh chat:',
  filterImages: 'Hình ảnh',
  filterDocuments: 'Tài liệu',
  searchFilePlaceholder: 'Tìm kiếm tệp/ảnh...',
  ...
  channelFilesTab: '📎 Files',
  noChannelFiles: 'Không tìm thấy ảnh hoặc file nào trong kênh này.',
  channelFilesLoading: 'Đang tải ảnh và file...',
  channelFilesImagesOnly: 'Chỉ hiển thị ảnh',
  selectChannelLabel: 'Chọn kênh chat:',
  filterImages: 'Ảnh',
  filterDocuments: 'Tài liệu',
  searchFilePlaceholder: 'Tìm kiếm tên tệp/ảnh...',
  drawUploadBtn: 'Vẽ từ ảnh',
  loadMoreFiles: 'Tải thêm',
  gifLibraryTab: 'GIFs',
  ...
  tourStepFilesTitle: '📎 Tiện ích Files',
  tourStepFilesDesc: 'Xem và quản lý tất cả các file, ảnh đã chia sẻ trong kênh hiện tại. Hỗ trợ phân trang, tìm kiếm theo tên và gửi nhanh vào chat!',

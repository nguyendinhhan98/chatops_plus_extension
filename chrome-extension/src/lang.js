...
const en = {
  ...
  aiAnalyzing: 'Analyzing and processing content...',
  aiApiKeyMissingError: 'Please configure your API Key in the extension Settings tab.',
  ...
  // AI Summarize
  aiAccordionTitle: 'AI Summarize',
  aiAccordionDesc: 'Configure AI provider & settings',
  aiProviderTitle: 'AI Provider',
  aiProviderDesc: 'Choose the AI model provider you want to use.',
  aiApiKeyTitle: 'API Key',
  aiApiKeyDesc: 'Enter your API Key to use AI-powered summarize and analysis features.',
  aiApiKeyPlaceholder: 'Paste API Key here...',
  aiCheckingKey: 'Checking API Key...',
  aiValidKey: '✅ API Key is valid!',
  aiInvalidKey: '❌ API Key is invalid or expired.',
  aiConnectionError: '❌ Connection error: Failed to validate API Key.',
  
  aiGuideTitleGemini: '🔑 How to get a free Gemini API Key',
  aiGuideStep1Gemini: 'Visit <a href="https://aistudio.google.com/apikey" target="_blank" style="color:var(--accent); text-decoration:none; font-weight:600;">https://aistudio.google.com/apikey</a>',
  aiGuideStep2Gemini: 'Sign in with your <strong>Google account</strong>',
  aiGuideStep3Gemini: 'Click <strong>Create API Key</strong> → select any project',
  aiGuideStep4Gemini: 'Copy the <strong>API Key</strong> → paste into the field above',
  aiGuideNoteGemini: '💡 <strong>Free Tier</strong> supports 15 requests/minute with Gemini Flash — no credit card required!',

  aiGuideTitleGroq: '🔑 How to get a free Groq API Key',
  aiGuideStep1Groq: 'Visit <a href="https://console.groq.com/keys" target="_blank" style="color:var(--accent); text-decoration:none; font-weight:600;">https://console.groq.com/keys</a>',
  aiGuideStep2Groq: 'Sign in with <strong>Google</strong> or your email',
  aiGuideStep3Groq: 'Click <strong>Create API Key</strong> → name it anything you want',
  aiGuideStep4Groq: 'Copy the generated key (starts with <code>gsk_</code>) → paste above',
  aiGuideNoteGroq: '💡 <strong>Groq Free Tier</strong> is extremely fast and has very generous rate limits!',

  aiGuideTitleOpenrouter: '🔑 How to get a free OpenRouter API Key',
  aiGuideStep1Openrouter: 'Visit <a href="https://openrouter.ai/keys" target="_blank" style="color:var(--accent); text-decoration:none; font-weight:600;">https://openrouter.ai/keys</a>',
  aiGuideStep2Openrouter: 'Sign in with <strong>Google</strong> or email',
  aiGuideStep3Openrouter: 'Click <strong>Create Key</strong> → name it (e.g. "ChatOps") and click Create',
  aiGuideStep4Openrouter: 'Copy the key (starts with <code>sk-or-</code>) → paste above',
  aiGuideNoteOpenrouter: '💡 <strong>OpenRouter</strong> provides access to multiple high-quality free models like Gemini 2.0 Flash Free!',

  aiSummarizeBtn: '🤖 AI',
  aiSummarizeBtnTooltip: 'AI Summarize / Analyze',
  aiAnalyzing: '🤖 Analyzing...',
  aiSummaryLabel: '🤖 AI Summary',
  aiNoApiKey: 'Please configure your API Key first.',
  aiNoApiKeySetup: 'Set up in Settings → AI Summarize',
  aiErrorGeneric: 'AI analysis failed. Please try again.',
  aiRateLimitError: 'Rate limit reached or quota exhausted. Please try again or switch provider.',
  aiForbiddenError: 'API Key does not have permission. Please check your key.',
  aiEmptyResponse: 'AI returned an empty response. Try with longer content.',
  aiCloseResult: 'Close',
  aiCopyResult: 'Copy',
...
const vi = {
  ...
  aiAnalyzing: 'Đang phân tích và xử lý nội dung...',
  aiApiKeyMissingError: 'Vui lòng cấu hình API Key trong tab Cài đặt của tiện ích mở rộng.',
  aiSummarizeTooltip: 'Tóm tắt nội dung AI',
  ...
  // AI Summarize
  aiAccordionTitle: 'AI Tóm tắt',
  aiAccordionDesc: 'Cấu hình nhà cung cấp AI & cài đặt',
  aiProviderTitle: 'Nhà cung cấp AI',
  aiProviderDesc: 'Chọn nhà cung cấp mô hình AI bạn muốn sử dụng.',
  aiApiKeyTitle: 'Mã API Key',
  aiApiKeyDesc: 'Nhập API Key để sử dụng tính năng tóm tắt và phân tích bằng AI.',
  aiApiKeyPlaceholder: 'Dán API Key tại đây...',
  aiCheckingKey: 'Đang kiểm tra API Key...',
  aiValidKey: '✅ API Key hợp lệ!',
  aiInvalidKey: '❌ API Key không hợp lệ hoặc đã hết hạn.',
  aiConnectionError: '❌ Lỗi kết nối: Không thể xác thực API Key.',

  aiGuideTitleGemini: '🔑 Cách lấy Gemini API Key miễn phí',
  aiGuideStep1Gemini: 'Truy cập <a href="https://aistudio.google.com/apikey" target="_blank" style="color:var(--accent); text-decoration:none; font-weight:600;">https://aistudio.google.com/apikey</a>',
  aiGuideStep2Gemini: 'Đăng nhập bằng <strong>tài khoản Google</strong> của bạn',
  aiGuideStep3Gemini: 'Nhấn <strong>Create API Key</strong> → chọn project bất kỳ',
  aiGuideStep4Gemini: 'Copy <strong>API Key</strong> → dán vào ô phía trên',
  aiGuideNoteGemini: '💡 <strong>Gói miễn phí</strong> hỗ trợ 15 request/phút với Gemini Flash — không cần thẻ tín dụng!',

  aiGuideTitleGroq: '🔑 Cách lấy Groq API Key miễn phí',
  aiGuideStep1Groq: 'Truy cập <a href="https://console.groq.com/keys" target="_blank" style="color:var(--accent); text-decoration:none; font-weight:600;">https://console.groq.com/keys</a>',
  aiGuideStep2Groq: 'Đăng nhập bằng tài khoản <strong>Google</strong> hoặc email',
  aiGuideStep3Groq: 'Nhấn <strong>Create API Key</strong> → đặt tên bất kỳ',
  aiGuideStep4Groq: 'Copy key được tạo (bắt đầu bằng <code>gsk_</code>) → dán vào ô phía trên',
  aiGuideNoteGroq: '💡 <strong>Groq Free Tier</strong> xử lý siêu tốc và có hạn mức miễn phí rất rộng rãi!',

  aiGuideTitleOpenrouter: '🔑 Cách lấy OpenRouter API Key miễn phí',
  aiGuideStep1Openrouter: 'Truy cập <a href="https://openrouter.ai/keys" target="_blank" style="color:var(--accent); text-decoration:none; font-weight:600;">https://openrouter.ai/keys</a>',
  aiGuideStep2Openrouter: 'Đăng nhập bằng tài khoản <strong>Google</strong> hoặc email',
  aiGuideStep3Openrouter: 'Nhấn <strong>Create Key</strong> → đặt tên bất kỳ (vd: "ChatOps") và nhấn Create',
  aiGuideStep4Openrouter: 'Copy key được tạo (bắt đầu bằng <code>sk-or-</code>) → dán vào ô phía trên',
  aiGuideNoteOpenrouter: '💡 <strong>OpenRouter</strong> cho phép bạn truy cập rất nhiều model miễn phí chất lượng cao như Gemini 2.0 Flash Free!',

  aiSummarizeBtn: '🤖 AI',
  aiSummarizeBtnTooltip: 'AI Tóm tắt / Phân tích',
  aiAnalyzing: '🤖 Đang phân tích...',
  aiSummaryLabel: '🤖 Kết quả AI',
  aiNoApiKey: 'Vui lòng cấu hình API Key trước.',
  aiNoApiKeySetup: 'Cấu hình tại Cài đặt → AI Tóm tắt',
  aiErrorGeneric: 'Phân tích AI thất bại. Vui lòng thử lại.',
  aiRateLimitError: 'Đạt giới hạn hoặc hết quota miễn phí. Vui lòng thử lại hoặc đổi nhà cung cấp.',
  aiForbiddenError: 'API Key không có quyền truy cập. Vui lòng kiểm tra lại.',
  aiEmptyResponse: 'AI trả về kết quả trống. Thử với nội dung dài hơn.',
  aiCloseResult: 'Đóng',
  aiCopyResult: 'Sao chép',
  aiActionSummarize: '📝 Tóm tắt',
  aiActionItems: '✅ Action Items',
